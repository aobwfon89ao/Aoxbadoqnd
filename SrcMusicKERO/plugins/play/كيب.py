...
@app.on_message(filters.regex("^/VIP"), group=39)
...
def reply_to_HEY(Client, message):
    message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
            [
                InlineKeyboardButton("مـطور سـورس الـحيتان", url=f"https://t.me/AT_W2"),
                InlineKeyboardButton("مـبرمج سورس الحيتان", url=f"https://t.me/AT_W3"),
            ]
         ]
     )
  )
